...
/**
 * Web service to redirect to the Documents app to display the document with the
 * given workspace and the given id
 */
@Path("/documents/view")
public class DocumentsAppRedirectService implements ResourceContainer {
  ...
  public DocumentsAppRedirectService(SessionProviderService sessionProviderService,
  ...
  public Response redirect(@Context
  HttpServletRequest request,
    ...
    try {
      ...
      ExtendedSession session = (ExtendedSession) systemSessionProvider.getSession(workspaceName,
